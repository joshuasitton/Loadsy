...
import { nameSimilarity, nameWords, sizeSimilarity, type Dims } from '../../src/domain/itemMatch';
...
// Name and size matching live in the app's domain, where the cross-room duplicate check
// uses them too – one definition of "the same kind of thing" for the product and its eval.
export { nameSimilarity, nameWords, sizeSimilarity };
